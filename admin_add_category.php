          ...
          <main role="main" id="content" class="content_full_width">
             ...
             <div class="tabs-area">
                <div id="tab-1" class="tab-box">
                  <form action="add_category.php" method="get" id="addCategoryForm">
                      <div style="margin-top:-10px">
                           <label for="name"><h4 style="font-size:20px; font-family:candara; font-style:italic;">Kategori Adı:</h4></label>
                           <input name="categoryName" type="text" class="form-control" id="categoryName">
                     </div>
                     <div>
                       <button type="submit" name="addBrand">Kategori Ekle</button>
                     </div>
                  </form>
                </div>
             </div>
