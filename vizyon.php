         ...
         <div id="main" class="tt-slider-">
                  ...
                  <div class="tools">
					   ...
					   <div class="frame">
						  ...
						  <h1><a href="index.html">Kurumsal </a><span class='current_crumb'>&nbsp;&nbsp; Vizyon </span></h1>
             ...
             <div class="post_content" align="center">
              <div class="modern_img_frame tt-blog-featured">
               <div class="img-preload">
                <a href='' title='' class='attachment-fadeIn'><img src='img/vizyonumuz.jpg' width='538' height='218' alt='' /></a>
               </div><!-- END img-preload -->
              </div><!-- END post_thumb -->
              </div><!-- END post_content -->

              <h6 class="heading-horizontal" style="margin:20px 0 50px 0;"><span> <strong>VİZYONUMUZ </strong></span></h6>
                 ...
                 <div class="testimonials flexslider">
                    <ul class="slides">
                       <li>
                          <blockquote>
                             <p>
“ Bilim ve teknoloji çözümleriyle endüstriyel sektöre yenilikçi ve değer katan ürünler sağlamak”
