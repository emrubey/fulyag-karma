...
<body>
  <?php include("etkdetayscript.php"); ?>
   <div id="tt-wide-layout" class="content-style-default">
      <div id="wrapper">
        <div class="header"><?php include('header.html');?></div>
         ...
         <div id="main">
			       <div class="main-area">
               <main role="main" id="content" class="content_full_width" style="width:1100px">
                  <h4 id="etkinlikDetayBaslik"></h4>
                  <p id="etkinlikMetin"></p>
                    <div class="" id="resimlistesi">
