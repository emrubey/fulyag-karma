         ...
         <div id="main" class="tt-slider-">
                  ...
                  <div class="tools">
					   ...
					   <div class="frame">
						  ...
						  <h1><a href="index.html">Kurumsal </a><span class='current_crumb'>&nbsp;&nbsp; Misyon </span></h1>
          ...
          <main role="main" id="content" class="content_full_width">
             ...
             <div class="post_content" align="center">
              ...
              <h6 class="heading-horizontal" style="margin:20px 0 50px 0;"><span> <strong>Misyonumuz </strong></span></h6>
                 ...
                 <div class="testimonials flexslider">
                    <ul class="slides">
                       <li>
                          <blockquote>
                             <p>
Bilim ve teknolojiyi yakından takip eden, değişime ve gelişime açık, inovasyon odaklı , ülkemiz için katma değer yaratan, yenilikçi fikirler ile endüstriyel sektörde en ileri seviyeye gitmek.
.<cite>&ndash;Fulyag</cite></p>
                          </blockquote>
                       </li>
                    </ul>
                 </div>
